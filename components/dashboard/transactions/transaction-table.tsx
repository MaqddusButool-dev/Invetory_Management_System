...
export function TransactionTable({ transactions: initialTransactions, onTransactionUpdate }: TransactionTableProps) {
  const [transactions, setTransactions] = useState<Order[]>(initialTransactions || []);
